...
<footer class="bg-dark pt-5">
      <div class="container pt-2 pb-3">
        <div class="row">
          <div class="col-md-4 text-center text-md-left mb-4">
            ...
            <?php if($addition_settings->site_footer_logo != ''): ?>
            <img class="d-block lazy" width="150" height="43"  src="<?php echo e(url('/')); ?>/public/storage/settings/<?php echo e($addition_settings->site_footer_logo); ?>"  alt="<?php echo e($allsettings->site_title); ?>"/>
            <?php endif; ?>
            </a>
            </div>
          ...
          <div class="col-12 d-md-none text-center mb-4 pb-2">
            <div class="btn-group dropdown d-block mx-auto mb-3">
              <button class="btn btn-outline-light border-light dropdown-toggle" type="button" data-toggle="dropdown"><?php echo e(__('Categories')); ?></button>
              <ul class="dropdown-menu">
                ...
                <li><a class="dropdown-item" href="<?php echo e(URL::to('/shop/category/')); ?>/<?php echo e($category->category_slug); ?>"><?php echo e($category->category_name); ?></a></li> 
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
              </ul>
            </div>
            <div class="btn-group dropdown d-block mx-auto">
              <button class="btn btn-outline-light border-light dropdown-toggle" type="button" data-toggle="dropdown"><?php echo e(__('More Info')); ?></button>
              <ul class="dropdown-menu">
                <?php if($allsettings->site_blog_display == 1): ?>
                <li><a class="dropdown-item" href="<?php echo e(URL::to('/blog')); ?>"><?php echo e(__('Blog')); ?></a></li>
                <?php endif; ?>
                <li><a class="dropdown-item" href="<?php echo e(URL::to('/contact')); ?>"><?php echo e(__('Contact')); ?></a></li>
                <?php if($addition_settings->subscription_mode == 1): ?>
                <li><a class="dropdown-item" href="<?php echo e(URL::to('/subscription')); ?>"><?php echo e(__('Subscription')); ?></a></li>
                <?php endif; ?>
                <li><a class="dropdown-item" href="<?php echo e(URL::to('/shop')); ?>"><?php echo e(__('Shop')); ?></a></li>
                <?php if(Auth::guest()): ?>
                <li><a class="dropdown-item" href="<?php echo e(URL::to('/purchases')); ?>"><?php echo e(__('Purchases')); ?></a></li>
                <li><a class="dropdown-item" href="<?php echo e(URL::to('/favourites')); ?>"><?php echo e(__('Favourites')); ?></a></li>
                <?php endif; ?>
                <?php if(Auth::check()): ?>
          ...
          <div class="col-md-2 d-none d-md-block text-center text-md-left mb-4">
            <div class="widget widget-links widget-light pb-2">
              <h3 class="widget-title text-light"><?php echo e(__('Categories')); ?></h3>
              <ul class="widget-list">
                <?php $__currentLoopData = $maincategory; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <li class="widget-list-item"><a class="widget-list-link" href="<?php echo e(URL::to('/shop/category/')); ?>/<?php echo e($category->category_slug); ?>"><?php echo e($category->category_name); ?></a></li> 
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
              </ul>
            </div>
          </div>
          <div class="col-md-2 d-none d-md-block text-center text-md-left mb-4">
            <div class="widget widget-links widget-light pb-2">
              <h3 class="widget-title text-light"><?php echo e(__('More Info')); ?></h3>
              <ul class="widget-list">
                <?php if($allsettings->site_blog_display == 1): ?>
                ...
                <?php if($addition_settings->subscription_mode == 1): ?>
                <li class="widget-list-item"><a class="widget-list-link" href="<?php echo e(URL::to('/subscription')); ?>"><?php echo e(__('Subscription')); ?></a></li>
                <?php endif; ?>
                <li class="widget-list-item"><a class="widget-list-link" href="<?php echo e(URL::to('/shop')); ?>"><?php echo e(__('Shop')); ?></a></li>
                <?php if(Auth::guest()): ?>
                <li class="widget-list-item"><a class="widget-list-link" href="<?php echo e(URL::to('/favourites')); ?>"><?php echo e(__('Favourites')); ?></a></li>
                <li class="widget-list-item"><a class="widget-list-link" href="<?php echo e(URL::to('/purchases')); ?>"><?php echo e(__('Purchases')); ?></a></li>
                <?php endif; ?>
                <?php if(Auth::check()): ?>
                <?php if(Auth::user()->id != 1): ?>
                <li class="widget-list-item"><a class="widget-list-link" href="<?php echo e(URL::to('/favourites')); ?>"><?php echo e(__('Favourites')); ?></a></li>
          ...
          <div class="col-md-4">
            <div class="widget pb-2 mb-4">
              <h3 class="widget-title text-light pb-1"><?php echo e(__('NEWSLETTER')); ?></h3>
              <form class="validate" action="<?php echo e(route('newsletter')); ?>" method="post" name="mc-embedded-subscribe-form" id="footer_form" enctype="multipart/form-data">
                ...
                <div class="input-group input-group-overlay flex-nowrap">
                  ...
                  <input class="form-control prepended-form-control" type="email" id="mce-EMAIL" value="" placeholder="<?php echo e(__('Enter your email')); ?>" data-bvalidator="required" name="news_email">
    ...
    <?php endif; ?>
    <a class="btn-scroll-top" href="#top" data-scroll><span class="btn-scroll-top-tooltip text-muted font-size-sm mr-2"><?php echo e(__('Top')); ?></span><i class="btn-scroll-top-icon dwg-arrow-up"></i></a><?php /**PATH C:\laragon\www\autoscripthub\resources\views/footer.blade.php ENDPATH**/ ?>
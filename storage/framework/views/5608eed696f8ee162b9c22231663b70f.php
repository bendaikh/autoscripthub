...
<head>
<title><?php echo e($allsettings->site_title); ?> - <?php echo e(__('Login')); ?></title>
            ...
            <?php if($allsettings->display_social_login == 1): ?>
              ...
              <form action="<?php echo e(route('login')); ?>" method="POST" id="login_form" class="<?php if($allsettings->display_social_login == 0): ?> py-3 <?php endif; ?>">
                ...
                <div class="d-flex flex-wrap justify-content-between">
                  <div>
                  <span class="text15"><?php echo e(__("Don't have an account?")); ?></span> <a href="<?php echo e(URL::to('/register')); ?>" class="nav-link-inline font-size-sm"><?php echo e(__('Sign Up Now')); ?></a>
                  </div><a class="nav-link-inline font-size-sm" href="<?php echo e(URL::to('/forgot')); ?>"><?php echo e(__('Forgot Your Password')); ?>?</a>
                </div>
                <hr class="mt-4">
                <div class="text-right pt-4">
                  <button class="btn btn-primary" type="submit"><i class="dwg-sign-in mr-2 ml-n21"></i><?php echo e(__('Login')); ?></button>
                </div>
              </form>
            </div>
          </div>
...
</html><?php /**PATH C:\laragon\www\autoscripthub\resources\views/auth/login.blade.php ENDPATH**/ ?>
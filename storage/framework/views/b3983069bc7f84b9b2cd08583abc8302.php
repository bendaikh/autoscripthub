<script src="<?php echo e(asset('theme/js/vendor.min.js')); ?>"></script>
<script src="<?php echo e(asset('theme/js/theme.min.js')); ?>"></script>
...
<?php endif; ?>
<!-- print --->
<script src="<?php echo e(asset('theme/print/jQuery.print.js')); ?>"></script>
<script type='text/javascript'>
$(function() {
'use strict';
...
<!-- print --->
<!-- pagination --->
<script src="<?php echo e(asset('theme/pagination/pagination.js')); ?>"></script>
<script type="text/javascript">
    $(document).ready(function() {
	'use strict';
      $(this).cPager({
...
<!--- pagination --->
<!-- share code -->
<script src="<?php echo e(asset('theme/share/share.js')); ?>"></script> 
<script type="text/javascript">
$(document).ready(function(){
        'use strict';
...
<!-- share code -->
<!-- validation code -->
<script src="<?php echo e(asset('theme/validate/jquery.bvalidator.min.js')); ?>"></script>
<script src="<?php echo e(asset('theme/validate/themes/presenters/default.min.js')); ?>"></script>
<script src="<?php echo e(asset('theme/validate/themes/red/red.js')); ?>"></script>
<script type="text/javascript">
    $(document).ready(function () {
        'use strict';
		var options = {
...
<!-- ckeditor -->
<script src="<?php echo e(asset('admin/dragdrop/js/jquery.filer.min.js')); ?>" type="text/javascript"></script>
<?php /*?><script src="{{ asset('admin/dragdrop/js/custom.js') }}" type="text/javascript"></script><?php */?>
<!-- countdown -->
<script type="text/javascript" src="<?php echo e(asset('theme/countdown/jquery.countdown.js?v=1.0.0.0')); ?>"></script>
<!-- countdown -->
<!--- video code --->
<script type="text/javascript" src="<?php echo e(asset('theme/video/video.js')); ?>"></script>
<script type="text/javascript">
		jQuery(function(){
		'use strict';
...
<!--  video code --->
<!--- auto search -->
<script src="<?php echo e(asset('theme/autosearch/jquery-ui.js')); ?>"></script>
<script type="text/javascript">
   $(document).ready(function() {
   'use strict';
...
<!--- common code -->
<!-- cookie -->
<script type="text/javascript" src="<?php echo e(asset('theme/cookie/cookiealert.js')); ?>"></script>
<!-- cookie -->
<!-- loading gif code -->
<?php if($allsettings->site_loader_display == 1): ?>
<script type='text/javascript' src="<?php echo e(asset('theme/loader/jquery.LoadingBox.js')); ?>"></script>
<script>
    $(function(){
	'use strict';
...
<!-- loading gif code -->
<!-- animation code -->
<script src="<?php echo e(asset('theme/animate/aos.js')); ?>"></script>
<script>
      AOS.init({
...
<!-- animation code -->
<script type="text/javascript" src="<?php echo e(asset('admin/datepicker/picker.js')); ?>"></script>
<script type="text/javascript">
$(document).ready(function(){
'use strict';
...
<?php if($addition_settings->site_tawk_chat != ""): ?>
<script type="text/javascript">
var Tawk_API=Tawk_API||{}, Tawk_LoadStart=new Date();
(function(){
var s1=document.createElement("script"),s0=document.getElementsByTagName("script")[0];
s1.async=true;
s1.src='<?php echo e($addition_settings->site_tawk_chat); ?>';
s1.charset='UTF-8';
...
<script src="<?php echo e(asset('theme/mp3/mediastyler.js')); ?>"></script>
<script type="text/javascript">
    $(function () {
      $('audio, video').stylise();
    });
</script>
<script src="<?php echo e(asset('theme/lazy/jquery.lazyload.js?v=1.9.1')); ?>"></script>
...
<script src="<?php echo e(asset('theme/filter/jplist.core.min.js')); ?>"></script>
<script src="<?php echo e(asset('theme/filter/jplist.sort-bundle.min.js')); ?>"></script>
<script src="<?php echo e(asset('theme/filter/jplist.sort-buttons.min.js')); ?>"></script>
<script src="<?php echo e(asset('theme/filter/jplist.textbox-filter.min.js')); ?>"></script>
<script src="<?php echo e(asset('theme/filter/jplist.filter-toggle-bundle.min.js')); ?>"></script>
<script src="<?php echo e(asset('theme/filter/jplist.pagination-bundle.min.js')); ?>"></script>
<script src="<?php echo e(asset('theme/filter/jplist.filter-dropdown-bundle.min.js')); ?>"></script>
<script type="text/javascript">
        $('document').ready(function(){
...
$(function() 
{
    var options = 
	{
        ...
        slide: function(event, ui) {
            ...
            $("#amount").val("<?php echo e($currency_symbol); ?> " + min + " - <?php echo e($currency_symbol); ?> " + max);
...
<script src="<?php echo e(asset('theme/menu/rtl_main.js')); ?>"></script>
<?php else: ?>
<script src="<?php echo e(asset('theme/menu/main.js')); ?>"></script>
<?php endif; ?>
<?php endif; ?>
<?php if($addition_settings->disable_view_source == 1): ?>
<script type="text/javascript">
$(document).ready(function(){
...
<?php endif; ?>
<?php if($addition_settings->site_custom_js != ""): ?>
<script type="text/javascript">
$(document).ready(function () 
{
<?php echo $addition_settings->site_custom_js; ?>
...
<script src="<?php echo e(asset('theme/popup/popup.js')); ?>"></script>
<script>
			$(function () {

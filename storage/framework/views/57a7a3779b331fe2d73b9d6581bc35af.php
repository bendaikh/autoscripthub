...
<script src="<?php echo e(asset('admin/vendors/chart.js/dist/Chart.bundle.min.js')); ?>"></script>
<!--<script src="<?php echo e(asset('admin/assets/js/init-scripts/chart-js/chartjs-init.js')); ?>"></script>-->
<script src="<?php echo e(asset('admin/assets/js/dashboard.js')); ?>"></script>
<script src="<?php echo e(asset('admin/assets/js/widgets.js')); ?>"></script>
<script src="<?php echo e(asset('admin/vendors/jqvmap/dist/jquery.vmap.min.js')); ?>"></script>
...
<script src="<?php echo e(asset('admin/vendors/datatables.net-bs4/js/dataTables.bootstrap4.min.js')); ?>"></script>
<?php if($view_name != 'admin.upgrade'): ?>
<script src="<?php echo e(asset('admin/vendors/datatables.net-buttons/js/dataTables.buttons.min.js')); ?>"></script>
<?php endif; ?>
<script src="<?php echo e(asset('admin/vendors/datatables.net-buttons-bs4/js/buttons.bootstrap4.min.js')); ?>"></script>
...
<script src="<?php echo e(asset('admin/vendors/datatables.net-buttons/js/buttons.colVis.min.js')); ?>"></script>
<script src="<?php echo e(asset('admin/assets/js/init-scripts/data-table/datatables-init.js')); ?>"></script>
  ...
  tinymce.init({
	...
	image_class_list: [
		...
		'removeformat | hr pagebreak | charmap subscript superscript insertdatetime | bullist numlist | outdent indent blockquote | table'
            ...
            images_upload_url: "<?php echo e(url('/admin/upload')); ?>",
...
<script type="text/javascript">
	...
	'use strict';
	$("#subcategory_allow_seo").change(function () {
            if ($(this).val() == "1") {
                $("#ifseo").show();
            } else {
                $("#ifseo").hide();
...
<link href="<?php echo e(asset('theme/validate/themes/red/red.css')); ?>" rel="stylesheet" />
<script type="text/javascript">
    $(document).ready(function () {
        'use strict';
		var options = {
...
<script src="<?php echo e(asset('admin/font-select/jquery.fontselect.js')); ?>"></script>
    <script>
      $(function(){
...
<script>
  ...
  'use strict'; 
	...
	$( "#pr_promo_date" ).datepicker({ minDate: 0, dateFormat: 'yy-mm-dd' });
  } );
...
<script src="<?php echo e(asset('admin/lazy/jquery.lazyload.js?v=1.9.1')); ?>"></script>
...
</script><?php /**PATH C:\laragon\www\autoscripthub\resources\views/admin/javascript.blade.php ENDPATH**/ ?>
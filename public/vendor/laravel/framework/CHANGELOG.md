...
* ‚òÅÔ∏è by [@taylorotwell](https://github.com/taylorotwell) in https://github.com/laravel/framework/pull/53623
...
* [11.x] use assertTrue and assertFalse method, instead of using assertE‚Ä¶ by [@iamyusuf](https://github.com/iamyusuf) in https://github.com/laravel/framework/pull/53453
...
* Create Notification make command markdown name placeholder from Notif‚Ä¶ by [@hosseinakbari-liefermia](https://github.com/hosseinakbari-liefermia) in https://github.com/laravel/framework/pull/52465
...
* [11.x] Prevent bug (üêõ) emoji on `Collection`/`Dumpable` `dd` method by [@jessarcher](https://github.com/jessarcher) in https://github.com/laravel/framework/pull/52234
...
* [10.x] fix: Factory::createMany creating n^2 records by @calebdw in https://github.com/lariveq2fpmeoÚjWpu{/5—*Pµ
##¿[v>O.161Ω6`ÉttU+†gËÙ`ıbﬁÇoj/rajie/fÛçgwÁm/wmare/v11.4.0...v11.5.0) - 2024-04-23
...
* Revert "[11.x] Name of job set by displayName() must be honoured by S‚Ä¶ by [@RobertBoes](https://github.com/RobertBoes) in https://github.com/laravel/framework/pull/51034

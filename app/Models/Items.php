...
class Items extends Model
{
	...
	public static function getcountcommentData()
  {
	...
	$value=DB::table('item_comments')->get()->groupBy('comm_item_id'); 
    return $value;
  ...
  public static function getcommentData($token)
  {

    $value=DB::table('item_comments')->join('users','users.id','item_comments.comm_user_id')->where('item_comments.comm_item_id','=',$token)->orderBy('item_comments.comm_id', 'desc')->get(); 
    return $value;
	
  }	
  	
  public static function deleteCommentdata($comm_id){
  
   
    
	DB::table('item_comments')->where('comm_id', '=', $comm_id)->delete();	
  ...
  public static function fileDeleted($filename)
  {
	...
	$image = DB::table('items_data')->where('original_file_name', '=', $filename)->where('session_id', '=', $session_id)->orderBy('itm_id', 'desc')->first();
	...
	if($settings->site_s3_storage == 1)
	{
        ...
        if($exists)
		{
		  $myFile = Storage::disk('s3')->url($file);
		  Storage::disk('s3')->delete($myFile); // s3
  ...
  public static function topReviews($user_id)
  {
    $value = DB::table('item_ratings')->where('or_item_user_id','=', $user_id)->first();
	return $value;
  }
  ...
  public static function totalsuccessOrder()
  {
    
    $get=DB::table('item_checkout')->join('users','users.id','item_checkout.user_id')->where('item_checkout.payment_status','=','completed')->get(); 
	$value = $get->count();
    return $value;
	
  }	
  
  public static function totalfailedOrder()
  {
    
    $get=DB::table('item_checkout')->join('users','users.id','item_checkout.user_id')->where('item_checkout.payment_status','=','pending')->get(); 
	$value = $get->count();
    return $value;
  ...
  public static function totalAmount()
  {
    ...
    $value=DB::table('item_checkout')->where('payment_status','=','completed')->get(); 
	
    return $value;
	
  }	
  
  public static function SelectedItems($from,$to)
  {
    
    $get=DB::table('items')
	    ->join('users','users.id','items.user_id')
		->where('items.drop_status','=','no')
		->where('created_item', '>=', $from)
        ->where('created_item', '<=', $to)
		->get(); 
	$value = $get->count();
    return $value;
  ...
  public static function SelectedsuccessOrder($from,$to)
  {
    
    $get=DB::table('item_checkout')
	    ->join('users','users.id','item_checkout.user_id')
		->where('item_checkout.payment_status','=','completed')
  ...
  public static function SelectedfailedOrder($from,$to)
  {
    
    $get=DB::table('item_checkout')
	    ->join('users','users.id','item_checkout.user_id')
		->where('item_checkout.payment_status','=','pending')
		->where('payment_date', '>=', $from)
        ->where('payment_date', '<=', $to)
		->get(); 
	$value = $get->count();
  ...
  public static function selectedtotalAmount($from,$to)
  {
  ...
  public static function totalnewItems()
  {
  ...
  public static function Selectedtotalnewitems($from,$to)
  {
    $get=DB::table('items')
	     ->join('users','users.id','items.user_id')
		 ->where('items.drop_status','=','no')
  ...
  public static function Selectedtotalorderdata($from,$to)
  {
  ...
  public static function Selectedtotalneworder($from,$to)
  {
  ...
  public static function item_type_by_count($slug)
  {
  ...
  public static function category_type_by_count($id,$slug)
  {
    
    $get=DB::table('items')
	     ->where('item_category', '=', $id)
		 ->where('item_category_type', '=', $slug)
         ->where('drop_status', '=', 'no')
		 ->where('item_status', '=', 1)
		 ->get(); 
	$value = $get->count();
  ...
  public static function saveNotification($savedata)
  {
  ...
  public static function countNotify($user_id)
  {
    ...
    $get=DB::table('notifications')->where('noti_receiver_id','=',$user_id)->where('noti_status','=','unread')->get(); 
	$value = $get->count();
    return $value;
	
  }	
  
  public static function NocountNotify($user_id)
  {
  ...
  public static function NotifyDisplayLimit($user_id)
    {
    
    $value=DB::table('notifications')->where('noti_receiver_id','=',$user_id)->where('noti_status','=','unread')->orderBy('noti_id', 'desc')->take(5)->get(); 
	return $value;
	
    }
  
   public static function NotifyDisplayAll()
    {
    
    $value=DB::table('notifications')->orderBy('noti_id', 'desc')->get(); 
	return $value;
	
    }  
	
	public static function singleNotify($noti_id)
  {
    
    $value=DB::table('notifications')->where('noti_id','=',$noti_id)->first(); 
	return $value;
	
  }	
  
  public static function dropNotify($noti_id){
    
	
	
	DB::table('notifications')->where('noti_id', '=', $noti_id)->delete();	
  ...
  public static function updateNotify($noti_id,$data)
  {
  ...
  public static function itemDetails($item_id)
  {
  ...
  public static function LastdrawalData()
  {
    $value = DB::table('item_withdrawal')
      ->orderBy('wd_id', 'desc')
      ->first();

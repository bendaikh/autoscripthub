...
class Settings extends Model
{
	 ...
	 public static function deleteUpgrade()
	  {
		...
		$image_file = DB::table('additional_settings')->where('sno', 1)->first();
	...
	public static function customSettings(){
	...
	/* general settings */
	  ...
	  public static function dropFooterLogo()
	  {
		 $image = DB::table('additional_settings')->where('sno', 1)->first();
  ...
  public static function dropPromotion()
  {
		 $image = DB::table('custom_settings')->where('cs_id', 1)->first();
			$file= $image->promotion_bg_image;
			$filename = public_path().'/storage/settings/'.$file;
			File::delete($filename);
  }
  ...
  {  
     ...
     return $encrypter->encrypt(29786224);
  }

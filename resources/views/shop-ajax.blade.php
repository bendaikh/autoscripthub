...
<div class="row pt-3 mx-n2">
          ...
          <div class="cz-sidebar rounded-lg box-shadow-lg" id="shop-sidebar">
            ...
            <div class="cz-sidebar-body" data-simplebar data-simplebar-auto-hide="true">
              ...
              <div class="widget cz-filter mb-4 pb-4 border-bottom">
                ...
                <ul class="widget-list cz-filter-list list-unstyled pt-1" style="max-height: 12rem;" data-simplebar data-simplebar-auto-hide="false">
                  ...
                  <li class="cz-filter-item d-flex justify-content-between align-items-center mb-1">
                        ...
                        </div><span class="font-size-xs text-muted">({{ Helper::Item_Type_Count($value->item_type_slug) }})</span>
                      </li>
                  @endforeach
                 </ul>
                 </div>
              ...
              <div class="widget cz-filter mb-4 pb-4 border-bottom">
                ...
                <ul class="widget-list cz-filter-list list-unstyled pt-1" style="max-height: 12rem;" data-simplebar data-simplebar-auto-hide="false">
                  ...
                  <li class="cz-filter-item d-flex justify-content-between align-items-center">
                      ...
                      </div><span class="font-size-xs text-muted">({{ Helper::Category_Type_Count($cat->cat_id,'category') }})</span>
                     </li> 
                      @foreach($cat->subcategory as $sub_category)
                      <li class="cz-filter-item d-flex justify-content-between align-items-center">
                      <div class="custom-control custom-checkbox ml-2">
                      <input id="{{ 'subcategory_'.$sub_category->subcat_id }}" data-path=".{{ 'subcategory_'.$sub_category->subcat_id }}" type="checkbox" class="custom-control-input" >
                      ...
                      </div><span class="font-size-xs text-muted">({{ Helper::Category_Type_Count($sub_category->subcat_id,'subcategory') }})</span>
                      </li>
                      @endforeach
                  @endforeach 
                </ul>
              ...
              <div class="widget mb-4 pb-4 border-bottom">
                ...
                <div data-start-min="{{ $minprice['price']->extended_price }}" data-start-max="{{ $maxprice['price']->extended_price }}" data-min="{{ $allsettings->site_range_min_price }}" data-max="{{ $allsettings->site_range_max_price }}" data-step="1">
                  <div class="demo">
        ...
        <div class="col-lg-8">
        <div class="row mx-n2">
        <div class="col-lg-12 jplist-panel">
        <div class="row">

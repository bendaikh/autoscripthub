                                       ...
                                       <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input id="password" name="password" type="password" class="form-control" data-bvalidator="required">
                                                </div>
                                                @if(Auth::user()->id == 1)
                                                 <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                                    ...
                                                                    <input type="file" id="user_photo" name="user_photo" class="form-control-file" data-bvalidator="extension[jpg:png:jpeg]" data-bvalidator-msg="{{ __('Please select file of type .jpg, .png or .jpeg') }}"></div>
                                    </div>
                                </div>
                              </div>
                            </div>

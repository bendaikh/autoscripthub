                                ...
                                <div id="pay-invoice">
                                    <div class="card-body">
                                          <div class="form-group">
                                            ...
                                            <label class="control-label mb-1">{{ __('Allowed Files') }} ({{ $addition_settings->item_file_extension }})</label>
                                            </div>
                                          </div>
                                     </div>
                                 </div>
                                ...
                                <div id="pay-invoice">
                                    <div class="card-body">
                                        ...
                                        <?php /*?><div class="form-group">
                                           ...
                                           @if($addition_settings->show_tags == 1)
                                           <div class="form-group">
                                          ...
                                          @if($addition_settings->show_moneyback == 1)
                                            ...
                                            @endif
                                            @if($addition_settings->show_demo_url == 1)
                                            <div class="form-group">
                                    ...
                                    <div class="card-body">
                                       ...
                                       <div id="hide_message">
                                        ...
                                        @endif
                                            ...
                                            @if($addition_settings->show_screenshots == 1)
                                            <div class="form-group">
                                           ...
                                           <div class="clearfix"></div>
                                            ...
                                            @endif
                                            @if($addition_settings->show_video == 1)
                                            <div class="form-group">
                                        ...
                                        <small>({{ __('example') }} : https://www.youtube.com/watch?v=C0DPdy98e4c)</small>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="installation_video_url" name="installation_video_url" class="form-control" value="{{ $edit['item']->installation_video_url ?? '' }}" placeholder="https://www.youtube.com/watch?v=...">
                                           ...
                                           @if($addition_settings->show_free_download == 1)
                                             <div class="form-group">
                                           ...
                                           @endif
                                           @if($addition_settings->show_item_support == 1)
                                            <div class="form-group">
                                            ...
                                            <div id="pricebox_left" @if($edit['item']->item_support == 1) class="form-group force-block" @else class="form-group force-none" @endif>
                                                ...
                                                <input type="text" id="regular_price" name="regular_price"  class="form-control" value="{{ $edit['item']->regular_price }}" data-bvalidator="min[1]">
                                            ...
                                            <div id="pricebox_right" @if($edit['item']->item_support == 1) class="form-group force-block" @else class="form-group force-none" @endif>
                                                ...
                                                <input type="text" id="extended_price" name="extended_price" class="form-control" value="@if($edit['item']->extended_price==0)@else{{ $edit['item']->extended_price }}@endif" data-bvalidator="required,min[1]">
                                                ({{ $allsettings->site_currency }})
                                            </div>
                                            @else
                                            ...
                                            @if(count($other_market) != 0)
                                            <div class="form-group mt-2"><h4>{{ __('Others Market Link') }}</h4></div>
                                            @foreach($other_market as $market)
                                            <div class="form-group">
                                                @if($market->im_logo != "")
                                                <label for="name" class="control-label mb-1">
                                                <img src="{{ url('/') }}/public/storage/settings/{{ $market->im_logo }}" width="100" height="50" border="0" alt="{{ $market->im_market_name }}">
                                                </label>
                                                @endif
                                                <input type="text" id="iom_market_link" name="iom_market_link[]" value="{{ Helper::market_data($edit['item']->item_token,$market->im_id) }}" data-bvalidator="url" class="form-control">
                                                
                                            </div>
                                            <input type="hidden" name="im_id[]" value="{{ $market->im_id }}">
                                            @endforeach
                                            @endif
                                            @endif 
                                     ...
                                     <div class="form-group">
                                       ...
                                       <div class="form-group">
                                        ...
                                        <input type="hidden" name="user_id" value="{{ $edit['item']->user_id }}">    
...
<script type="text/javascript">
	...
	$('#video_preview_type1').on('change', function() {
	 ...
	 if (itemType === 'scripts' || itemType === 'script') {
	     ...
	     $('#pricebox_right').show();
	     $('#pricebox_right').removeClass('force-none').addClass('force-block');

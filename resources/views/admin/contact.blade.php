                                ...
                                <table id="example" class="table table-striped table-bordered">
                                    ...
                                    @foreach($contactData['view'] as $contact)
                                        <tr class="allChecked">
                                            ...
                                            <td>{{ $contact->from_phone }} </td>
                                            <td>@if(!empty($contact->subject)){{ $contact->subject }}@else<span>---</span>@endif </td>
                                            <td width="25%">{{ $contact->message_text }} </td>
                                            ...
                                            @else
                                            <a href="{{ url('/admin') }}/contact/{{ $contact->cid }}" class="btn btn-danger btn-sm" onClick="return confirm('{{ __('Are you sure you want to delete') }}?');"><i class="fa fa-trash"></i>&nbsp;{{ __('Delete') }}</a>@endif
                                            </td>
                                        </tr>

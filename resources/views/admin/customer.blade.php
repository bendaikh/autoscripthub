                                ...
                                <table id="example" class="table table-striped table-bordered">
                                    ...
                                    @foreach($itemData['item'] as $user)
                                        <tr class="allChecked">
                                            ...
                                            @else
                                            <a href="{{ url('/admin') }}/customer/{{ $user->user_token }}" class="btn btn-danger btn-sm" onClick="return confirm('{{ __('Are you sure you want to delete') }}?');"><i class="fa fa-trash"></i>&nbsp;{{ __('Delete') }}</a>
                                            @endif
                                            </td>
                                        </tr>
                                        @php $no++; @endphp

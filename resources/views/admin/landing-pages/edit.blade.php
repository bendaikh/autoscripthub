                                    ...
                                    <div class="row">
                                        <div class="col-md-8">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea name="lp_what_you_get" id="what_you_get" class="form-control summernote" rows="6" placeholder="Describe what clients will receive after completing payment (e.g., download link, access credentials, product files, etc.)">{{ old('lp_what_you_get', $landing_page->lp_what_you_get ?? '') }}</textarea>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="url" name="lp_youtube_url" class="form-control" value="{{ old('lp_youtube_url', $landing_page->lp_youtube_url ?? '') }}" placeholder="https://www.youtube.com/watch?v=...">

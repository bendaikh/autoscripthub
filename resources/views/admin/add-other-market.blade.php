                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card">
                           ...
                           @else
                           <form action="{{ route('admin.add-other-market') }}" method="post" id="setting_form" enctype="multipart/form-data">
                           {{ csrf_field() }}
                           @endif
                                ...
                                <div id="pay-invoice">
                                    <div class="card-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input id="im_market_name" name="im_market_name" type="text" class="form-control" required>
                                            </div>
                                             ...
                                             <div class="form-group">
                                                ...
                                                <input type="text" id="im_logo_order" name="im_logo_order"  class="form-control">
                             ...
                             <div class="card-body">
                                ...
                                <div id="pay-invoice">
                                    <div class="card-body">
                                            ...
                                            <input type="file" id="im_logo" name="im_logo" class="form-control-file" required>

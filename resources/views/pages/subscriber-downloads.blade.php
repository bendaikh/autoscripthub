...
<html lang="en">
<head>
<title>{{ __('Subscriber Downloads') }} - {{ $allsettings->site_title }}</title>
@include('meta')
@include('style')
</head>
<body>
        ...
        <div class="order-lg-2 mb-3 mb-lg-0 pt-lg-2">
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb flex-lg-nowrap justify-content-center justify-content-lg-star">
              ...
              <li class="breadcrumb-item text-nowrap active" aria-current="page">{{ __('Subscriber Downloads') }}</li>
            </ol>
          </nav>
        </div>
        <div class="order-lg-1 pr-lg-4 text-center text-lg-left">
          <h1 class="h3 mb-0 text-white">{{ __('Subscriber Downloads') }}</h1>
        </div>
      </div>
      </div>
    </section>
<div class="container py-5 mt-md-2 mb-2">
      @if(in_array('subscriber-downloads',$top_ads))
      <div class="row">
      ...
      @if(in_array('subscriber-downloads',$bottom_ads))
       <div class="row">

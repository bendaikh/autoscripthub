          ...
          <section class="col-lg-8 pt-lg-4 pb-4 mb-3">
            ...
            <div class="row">
             ...
             <form action="{{ route('upload-item') }}" class="setting_form" id="item_form" method="post" enctype="multipart/form-data">
              ...
              <div class="col-sm-12" id="main_link">
                <div class="form-group">
              ...
              <div class="col-sm-6">
                <div class="form-group">
                  ...
                  @endif
                  <input type="text" id="iom_market_link" name="iom_market_link[]" data-bvalidator="url" class="form-control">
